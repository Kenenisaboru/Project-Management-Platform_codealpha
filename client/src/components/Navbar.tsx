    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-4 sm:pt-6 px-4">
      <nav className="flex w-full max-w-5xl items-center justify-between rounded-2xl sm:rounded-full border border-white/10 bg-[#0A0A0A]/60 px-4 sm:px-6 py-3 backdrop-blur-2xl shadow-2xl shadow-black/50">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 font-bold text-white shadow-[0_0_15px_rgba(99,102,241,0.4)] transition-transform group-hover:scale-105 group-hover:rotate-3 group-hover:shadow-[0_0_25px_rgba(168,85,247,0.6)]">
            T
          </div>
